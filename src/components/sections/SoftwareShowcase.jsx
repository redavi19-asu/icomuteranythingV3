        ...
        >
          ...
          <div className="relative z-10 grid gap-10 lg:grid-cols-[.92fr_1.08fr] lg:items-center">
            <div>
              ...
              <p className="text-gray-300 leading-relaxed text-lg max-w-2xl">
                ICA Unified gives each company its own secure workspace, then gives employees, managers, administrators, and platform staff the right view for the work they need to do.
              </p>
