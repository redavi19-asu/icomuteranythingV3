...
function HowItWorks({ onRequestService }) {
  ...
  const steps = [
    { number: '01', title: 'Request Service', description: 'Tell me what you need and I\'ll get back to you quickly with availability and a preliminary assessment.', icon: '📋' },
    { number: '02', title: 'Diagnose & Quote', description: 'I assess your situation and give you a clear quote before any work begins.', icon: '🔍' },
    { number: '03', title: 'Fix, Build, or Deploy', description: 'I deliver the solution and make sure everything is working properly before the job is finished.', icon: '✅' },
  ]
  const serviceOptions = [
    ...
    { icon: '📍', title: 'DMV On-Site Service', description: 'I\'m based in the Washington, D.C. metro area, with on-site service available throughout Washington, D.C., Maryland, and Virginia.' },
    { icon: '✈️', title: 'Travel Available', description: 'Have a project outside the DMV that needs hands-on support? I can travel for the right project.' },
  ]
  ...
  return (
    <section id="how-it-works" className="py-24 px-6 relative bg-gradient-to-b from-transparent to-blue-950/10"><div className="max-w-6xl mx-auto">
      <motion.div ref={ref} initial={{ opacity: 1, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }} className="text-center mb-20"><h2 className="section-title mb-6">How I Work</h2><p className="section-subtitle">A simple, transparent process from start to finish.</p></motion.div>
